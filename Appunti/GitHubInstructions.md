...
* Creo nuovo progetto su Eclipse normalmente: `File > New > Java Project`
...
* **Push del progetto** da Eclipse: `Team > Push Branch Master`, copio link nel campo `URL`, seleziono `Next > Finish > Close`.
...
* Scelgo i branch che voglio copiare, `Next > Next > Finish`.
