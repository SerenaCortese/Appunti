...
3. Salvo versione del progetto nel repository che è ancora vuoto (i file sono nel workingspace), **PRIMO COMMIT DEL PROGETTO**:
* `Team`
* `Commit`
...
4. Creo progetto nell'area personale su GitHub:
...
5. Su Eclipse faccio Push:
* `Team`
* `Push Branch Master`
* copio link sull'`URL` tab
* `Next`
* `Next`
* `Finish`
* `Close`.
